...
export function Details({route, path} : svgInputs) {
  return (
    <svg
      width="52"
      height="52"
...
export function Verify({ route, path }: svgInputs) {
  return (
    <svg
      width="52"
      height="52"
...
export function Welcome({ route, path }: svgInputs) {
    return (
      <svg
        width="52"
        height="52"
...
export function Invite({ route, path }: svgInputs) {
