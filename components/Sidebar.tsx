...
export default function Sidebar() {
  ...
  return (
    <div className="flex flex-col justify-between h-auto bg-[#F7F7F5] hidden lg:flex pt-[116px] pb-[35px] min-w-[380px] px-[21px]">
      <div>
        <div
          className={clsx("flex gap-[17px]", {
            "text-[#171A1F]": path === "/sign-up",
            "text-[#9095A0]": path !== "/sign-up",
          })}
        >
          <svg
            width="52"
          ...
          >
            <g filter="url(#filter0_dd_1_2127)">
              ...
              <path
                ...
                fill={path === "/sign-up" ? "#171A1F" : "#9095A0"}
              />
            </g>
            <defs>
              <filter
          ...
          <div className="flex flex-col leading-[26px] text-[16px]">
            <div className="font-bold">Your details</div>
            <div className="font-normal">
              Provide your details for your account
            </div>
          </div>
        </div>
        <div className="h-[56px] ml-[24px] border-l-2 border-[#5E8AF7]"></div>
        <div
          className={clsx("flex gap-[17px]", {
            "text-[#171A1F]": path === "/sign-up/verify-email-address",
            "text-[#9095A0]": path !== "/sign-up/verify-email-address",
          })}
        >
          <svg
            width="52"
          ...
          <div className="flex flex-col leading-[26px] text-[16px]">
            ...
            <div className="font-normal">Enter your verification code</div>
          </div>
        </div>
        <div className="h-[56px] ml-[24px] border-l-2 border-[#5E8AF7]"></div>
        <div
          className={clsx("flex gap-[17px]", {
            "text-[#171A1F]": path === "/sign-up/collaboration",
            "text-[#9095A0]": path !== "/sign-up/collaboration",
          })}
        >
          <svg
            width="52"
          ...
          >
            <g filter="url(#filter0_dd_1_2136)">
              ...
              <path
                ...
                fill={path === "/sign-up/collaboration" ? "#171A1F" : "#9095A0"}
              />
              <path
          ...
          <div className="flex flex-col leading-[26px] text-[16px]">
            <div className="font-bold">Invite your team</div>
            <div className="font-normal">
        ...
        <div
          className={clsx("flex gap-[17px]", {
            "text-[#171A1F]": path === "/sign-up/welcome",
            "text-[#9095A0]": path !== "/sign-up/welcome",
          })}
        >
          <svg
            width="52"
          ...
          >
            <g filter="url(#filter0_dd_1_2142)">
              ...
              <path
                d="M16 36L36 36"
                stroke={path === "/sign-up/welcome" ? "#171A1F" : "#9095A0"}
                stroke-width="2.4"
          ...
          <div className="flex flex-col leading-[26px] text-[16px]">
            <div className="font-bold">Welcome to DokkuAi</div>
            <div className="font-normal">Get up and running in 3 mins</div>
          </div>
        </div>
      </div>
